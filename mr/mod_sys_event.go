...
var eventTypes = []string{"wan_down", "wan_up", "failover", "apply", "rollback", "login_lock", "new_device", "boot", "upgrade", "doctor", "cert", "wifi", "ddns", "update", "archive", "watchcat", "device", "dial"}
